...
import pic1 from'./images/MOURI Tech2.png'
import pic2 from'./images/photo aa.jpg'
import pic3 from'./images/photo ask.jpg'
import pic4 from'./images/laptap.png'
                 ...
                 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   ...
                   <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu">
                       ...
                       <li><a class="dropdown-item" href="about java script">JAVA SCRIPT</a></li>
                     </ul>
                   </li>
                   <li class="nav-item">
